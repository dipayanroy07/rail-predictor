...
class DisruptionImpactCalibrationAssessorTest {
    ...
    private final DisruptionImpactCalibrationAssessor assessor = new DisruptionImpactCalibrationAssessor();
    ...
    @Test
    void alwaysReportsStructurallyUnaffectedEvenWithDisruptionData() {
